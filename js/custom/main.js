...
$(document).ready(function () {
	...
	var bar = new ProgressBar.Circle(progressContainer, {
		...
		from: { color: '#DFE3EE', width: 1 },
		to: { color: '#4C7BC1', width: 4 },
	...
	bar.text.style.fontFamily = "'Open Sans', Helvetica, Arial, sans-serif";
	bar.text.style.fontWeight = '900';
	bar.text.style.fontSize = '48px';
	bar.text.style.color = '#828282';

	bar.animate(1.0);  // Number from 0.0 to 1.0

	setTimeout(function() {
		$("#loader").addClass('endLoad');
		setTimeout(function() {
